 ...
 const SHOPIFY_STORE_PERMANENT_DOMAIN = 'botgenius-hub-dlx7o.myshopify.com';
 ...
 export async function createShopifyCart(item: any): Promise<{ cartId: string; checkoutUrl: string; lineId: string } | null> {
 ...
 export async function addLineToShopifyCart(cartId: string, item: any): Promise<{ success: boolean; lineId?: string; cartNotFound?: boolean }> {
